    ...
    <DashboardLayout userType={userType}>
      <div className="h-[calc(100vh-2rem)] p-4">
        ...
        <div className="grid grid-cols-3 gap-4 h-[calc(100%-5rem)]">
          {/* Conversations List */}
          <Card className="p-4 border border-border overflow-hidden flex flex-col">
            <div className="mb-4">
              ...
              {conversations.map((conv, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    selectedChat === i ? "bg-accent" : "hover:bg-muted"
                  )}
                >
          ...
          {/* Chat Window */}
          <Card className="col-span-2 border border-border flex flex-col">
